...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full bg-black relative flex flex-col items-center justify-start min-h-screen">
    <div className="absolute pointer-events-none inset-0 flex items-center justify-center bg-black [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"></div>
  
    <div className="relative overflow-y-auto w-full flex-grow">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24">
        <div className="text-center">
          <h1 className="text-4xl sm:text-6xl font-bold text-neutral-200">
            Verba<span className="text-green-500">Translate</span>
          </h1>
  
          <p className="mt-3 text-neutral-400 max-w-2xl mx-auto text-lg leading-relaxed">
            Break language barriers with VerbaTranslate, your ultimate AI-powered translation companion. Seamlessly communicate across languages and cultures with cutting-edge voice and text translation technology.
          </p>
  
          <div className="mt-7 sm:mt-12 mx-auto max-w-3xl relative">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-7 sm:mt-12 mx-auto max-w-3xl">
